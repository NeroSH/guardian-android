...
/**
 * The three lines it takes to add a column to the report — the working example every future
 * implementation copies.
 */
@RunWith(AndroidJUnit4::class)
class NoEncryptionBaselineBenchmarkTest : AbstractEncryptedDataStoreBenchmarkTest() {
    override val target: EncryptedDataStoreBenchmark = NoEncryptionBaselineTarget()
}
